#!/usr/bin/env python3
"""
Cliente de BBVA para comunicaciones mTLS con Banco Santander
...
def main():
    ...
    try:
        ...
        transfers = [
            {"amount": 5000.00, "destination_account": "ACC-SANTANDER-101", "description": "Transferencia corporativa"},
            {"amount": 3200.75, "destination_account": "ACC-SANTANDER-102", "description": "Pago de proveedores"},
            {"amount": 1250.00, "destination_account": "ACC-SANTANDER-103", "description": "Retiro de fondos"},
        ]
        ...
        for i, transfer_info in enumerate(transfers, 1):
            ...
            print(f"    Monto: €{transfer_info['amount']:.2f}")
